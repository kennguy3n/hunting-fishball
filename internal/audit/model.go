...
const (
	...
	// Round-7 admin lifecycle additions.
	ActionRetrievalQueryRecorded  Action = "retrieval.query_recorded"
	ActionSourceCredentialInvalid Action = "source.credential_invalid"
	ActionSourceBulkAction        Action = "source.bulk_action"
	ActionRetrievalCacheWarmed    Action = "retrieval.cache_warmed"
	ActionRetrievalPinned         Action = "retrieval.pinned"
	ActionRetrievalBudgetUpdated  Action = "retrieval.budget_updated"
	ActionCacheConfigUpdated      Action = "cache.config_updated"
	ActionChunkConflictResolved   Action = "chunk.conflict_resolved"
	ActionChunkQualityScored      Action = "chunk.quality_scored"
